    ...
    <header>
      ...
      <div class="h-[80px] w-full flex gap-6 justify-evenly items-center">
        <div class="flex gap-6 items-center">
          ...
          <a href="/" class="spa text-gray-600 font-semibold hover:text-blue-400">Home</a>
          <a href="/about" class="spa text-gray-600 font-semibold hover:text-blue-400">Tentang</a>
        </div>
